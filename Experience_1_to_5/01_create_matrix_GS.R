...
library(xlsx)
negative_table = read.xlsx("data/gold_standard/negative_table.xlsx", sheetIndex = 1)
positive_table = read.xlsx("data/gold_standard/positive_table.xlsx", sheetIndex = 1)
...
saveRDS(matrix_GS, "data/gold_standard/matrix_GS.rds")
